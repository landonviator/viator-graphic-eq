...
void ViatorParameters::Params::initSliderParams()
{
    ...
    // io attach
    _ioSliderParams.push_back({ViatorParameters::inputID,
        ViatorParameters::inputName,
        -20.0f, 20.0f, 0.0f,
        skew::kNoSkew,
        0.0,
        type::kFloat});
    _ioSliderParams.push_back({ViatorParameters::outputID,
        ViatorParameters::outputName,
        -20.0f, 20.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    // filter attach
    _filterSliderParams.push_back({ViatorParameters::highpassID,
        ViatorParameters::highpassName,
        20.0f, 20000.0f, 20.0f,
        skew::kSkew,
        1000.0,
    ...
    _filterSliderParams.push_back({ViatorParameters::lowpassID,
        ViatorParameters::lowpassName,
        20.0f, 20000.0f, 20000.0f,
        skew::kSkew,
        1000.0,
    ...
    // bands attach
    _bandSliderParams.push_back({ViatorParameters::band1GainID,
        ViatorParameters::band1GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band2GainID,
        ViatorParameters::band2GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band3GainID,
        ViatorParameters::band3GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band4GainID,
        ViatorParameters::band4GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band5GainID,
        ViatorParameters::band5GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band6GainID,
        ViatorParameters::band6GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band7GainID,
        ViatorParameters::band7GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band8GainID,
        ViatorParameters::band8GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band9GainID,
        ViatorParameters::band9GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
    ...
    _bandSliderParams.push_back({ViatorParameters::band10GainID,
        ViatorParameters::band10GainName,
        -15.0f, 15.0f, 0.0f,
        skew::kNoSkew,
        0.0,
